...
describe('themes', function () {
  ...
  describe('fallback', function () {
    it('falls back to pkg dir', function (done) {
      ...
      expect((0, _stringify2.default)(theme)).to.equals((0, _stringify2.default)(tobj));
      expect((0, _stringify2.default)(list)).to.equals((0, _stringify2.default)(lobj));
